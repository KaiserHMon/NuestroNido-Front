...
export const EliminarFamiliaSchema = z.object({
  confirmacionTexto: z
    .string()
    .min(1, "Debes confirmar escribiendo el nombre de la familia"),
  nombreFamilia: z.string(),
}).refine(
  (data) => data.confirmacionTexto === data.nombreFamilia,
  {
 ...
 */
export const validarFortalezaContraseña = (
  password: string
): "weak" | "medium" | "strong" => {
  let strength = 0
