...
import { Bird, Calendar, ShoppingCart, StickyNote, Trophy, Check, ArrowRight } from "lucide-react"
...
export default function LandingPage() {
  return (
    <div className="min-h-screen relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <span className="text-lg sm:text-xl font-bold text-foreground">NuestroNido</span>
            </div>
      ...
      <section className="container mx-auto px-4 sm:px-6 py-12 sm:py-20 md:py-32">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-base sm:text-lg md:text-xl text-foreground mb-6 sm:mb-8 text-pretty max-w-2xl mx-auto px-2">
            NuestroNido es la plataforma que ayuda a las familias a coordinar tareas, compartir listas de compras y
            mantenerse organizados con un sistema de gamificación que motiva a todos.
          </p>
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4">
            <Link href="/dashboard" className="w-full sm:w-auto">
              <Button
                size="lg"
                className="w-full sm:w-auto bg-primary hover:bg-primary/90 text-base sm:text-lg px-6 sm:px-8"
              >
                Crear mi Nido
            ...
            <Button
              size="lg"
              variant="outline"
              className="w-full sm:w-auto border-primary text-primary hover:bg-primary hover:text-primary-foreground text-base sm:text-lg px-6 sm:px-8 bg-transparent"
            >
              Ver Demo
            </Button>
          </div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            <Card className="border-card bg-card">
              <CardHeader className="p-4 sm:p-6">
                ...
                <CardTitle className="text-lg sm:text-xl text-primary">Calendario Familiar</CardTitle>
                <CardDescription className="text-sm sm:text-base text-foreground">
                  Organiza tareas únicas o recurrentes, asigna responsables y visualiza todo en un calendario intuitivo
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-card bg-card">
              <CardHeader className="p-4 sm:p-6">
                ...
                <CardTitle className="text-lg sm:text-xl text-primary">Listas Compartidas</CardTitle>
                <CardDescription className="text-sm sm:text-base text-foreground">
                  Crea listas de compras por categorías que toda la familia puede ver y actualizar en tiempo real
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-card bg-card">
              <CardHeader className="p-4 sm:p-6">
                ...
                <CardDescription className="text-sm sm:text-base text-foreground">
                  Sistema de puntos y tabla de posiciones que motiva a todos a participar en las tareas del hogar
                </CardDescription>
              </CardHeader>
            </Card>
            ...
            <Card className="border-card bg-card">
              <CardHeader className="p-4 sm:p-6">
                ...
                <CardTitle className="text-lg sm:text-xl text-primary">Notas Familiares</CardTitle>
                <CardDescription className="text-sm sm:text-base text-foreground">
      ...
      {/* How it Works */}
      <section className="container mx-auto px-4 sm:px-6 py-12 sm:py-20 bg-card border border-card">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10 sm:mb-16 px-2">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-primary mb-3 sm:mb-4">Cómo funciona</h2>
          ...
          <div className="space-y-6 sm:space-y-8">
            ...
            <div className="flex gap-4 sm:gap-6 items-start">
              ...
              <div>
                <h3 className="text-xl sm:text-2xl font-bold text-primary mb-2">Invita a tu familia</h3>
                <p className="text-foreground text-base sm:text-lg">
            ...
            <div className="flex gap-4 sm:gap-6 items-start">
              ...
              <div>
                <h3 className="text-xl sm:text-2xl font-bold text-primary mb-2">Organízate y colabora</h3>
                <p className="text-foreground text-base sm:text-lg">
                  Asigna tareas, comparte listas, gana puntos y mantén a toda la familia sincronizada.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="container mx-auto px-4 sm:px-6 py-12 sm:py-20 bg-card/50 backdrop-blur-sm">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6 sm:gap-8">
            ...
            <Card className="border-card bg-card flex flex-col">
              ...
              <CardContent className="px-4 pb-4 sm:px-6 sm:pb-6 flex flex-col flex-grow">
                <ul className="space-y-2 sm:space-y-3 mb-4">
                  ...
                  <li className="flex items-start gap-2">
                    <Check className="w-4 h-4 sm:w-5 sm:h-5 text-primary flex-shrink-0 mt-0.5" />
                    <span className="text-foreground text-sm sm:text-base">Hasta 5 tareas semanales</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Check className="w-4 h-4 sm:w-5 sm:h-5 text-primary flex-shrink-0 mt-0.5" />
                    <span className="text-foreground text-sm sm:text-base">Hasta 3 notas permanentes</span>
                  </li>
                </ul>
            ...
            {/* Premium Plan */}
            <Card className="border-primary bg-card shadow-xl relative flex flex-col">
              <div className="absolute -top-3 sm:-top-4 left-1/2 -translate-x-1/2 bg-primary text-primary-foreground px-3 sm:px-4 py-1 rounded-full text-xs sm:text-sm font-medium">
                Más Popular
              </div>
              <CardHeader className="p-4 sm:p-6">
              ...
              <CardContent className="px-4 pb-4 sm:px-6 sm:pb-6 flex flex-col flex-grow">
                <ul className="space-y-2 sm:space-y-3 mb-4">
                  ...
                  <li className="flex items-start gap-2">
                    <Check className="w-4 h-4 sm:w-5 sm:h-5 text-primary flex-shrink-0 mt-0.5" />
                    <span className="text-foreground text-sm sm:text-base">Tareas ilimitadas</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Check className="w-4 h-4 sm:w-5 sm:h-5 text-primary flex-shrink-0 mt-0.5" />
                  ...
                  <li className="flex items-start gap-2">
                    <Check className="w-4 h-4 sm:w-5 sm:h-5 text-primary flex-shrink-0 mt-0.5" />
                    <span className="text-foreground text-sm sm:text-base">--</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <Check className="w-4 h-4 sm:w-5 sm:h-5 text-primary flex-shrink-0 mt-0.5" />
                    <span className="text-foreground text-sm sm:text-base">Acceso anticipado a nuevas funcionalidades</span>
                  </li>
                </ul>
                <Link href="/dashboard" className="block mt-auto">
                  <Button className="w-full bg-primary hover:bg-primary/90 text-sm sm:text-base">
      ...
      <section className="container mx-auto px-4 sm:px-6 py-12 sm:py-20">
        <div className="max-w-4xl mx-auto text-center bg-card rounded-2xl sm:rounded-3xl p-8 sm:p-12 shadow-2xl">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-primary mb-3 sm:mb-4">
      ...
      <footer className="border-t border-card bg-card/80 backdrop-blur-sm">
        <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-12">
          <div className="flex flex-col items-center text-center gap-4">
            ...
            <p className="text-foreground/80 text-sm sm:text-base max-w-md">Organizando familias, un nido a la vez.</p>
            <div className="border-t border-card w-full max-w-md mt-4 pt-4">
              <p className="text-xs sm:text-sm text-foreground/80">© 2025 NuestroNido. Todos los derechos reservados.</p>
            </div>
          </div>
        </div>
      </footer>
