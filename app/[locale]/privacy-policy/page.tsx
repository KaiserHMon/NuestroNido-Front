            ...
            <div className="space-y-8 text-foreground/90">
              <section>
                ...
                <div className="bg-background/50 p-4 rounded-lg border border-border">
                  <p className="mb-2">
                    Para brindarte nuestros servicios, únicamente almacenamos la siguiente
                    información básica:
                  </p>
                  <ul className="list-disc list-inside space-y-1 ml-2 text-muted-foreground">
                    <li>
                      <span className="font-medium text-foreground">Nombre completo</span>{' '}
                      (proporcionado por tu cuenta de Google).
                    </li>
                    <li>
                    ...
                    <li>
                      <span className="font-medium text-foreground">Foto de perfil</span> (si está
                      disponible en tu cuenta de Google).
                    </li>
                  </ul>
                </div>
              </section>
              ...
              <section>
                ...
                <ul className="list-disc list-inside mt-2 ml-2 text-muted-foreground space-y-1">
                  ...
                  <li>
                    Asignar y gestionar tareas, listas y eventos dentro de tu &quot;Nido&quot;
                    (grupo familiar).
                  </li>
                </ul>
              </section>
              ...
              <section>
                ...
                <p className="mb-2">
                  Para garantizar la seguridad y fiabilidad de nuestra plataforma, utilizamos la
                  infraestructura de proveedores de confianza:
                </p>
                <div className="grid sm:grid-cols-2 gap-4">
                  <div className="bg-background/50 p-4 rounded-lg border border-border">
                    <strong className="block text-foreground mb-1">Google</strong>
                    <span className="text-sm text-muted-foreground">
                      Utilizado como proveedor de identidad para asegurar un inicio de sesión rápido
                      y seguro.
                    </span>
                  </div>
                  <div className="bg-background/50 p-4 rounded-lg border border-border">
                    ...
                    <span className="text-sm text-muted-foreground">
                      Provee nuestra base de datos y sistema de autenticación, asegurando que tus
                      datos estén encriptados y protegidos.
                    </span>
                  </div>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="bg-background/50 p-4 rounded-lg border border-border">
                  <p className="text-foreground">
                    ...
                    para fines publicitarios ni comerciales. Tu privacidad es nuestra prioridad.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <p>
                  Tienes el control total sobre tu información. Si en algún momento deseas dejar de
                  usar NuestroNido, puedes eliminar tu cuenta y todos tus datos asociados desde la
                  pantalla de <span className="font-medium text-foreground">Inicio (Home)</span>.
                  Ten en cuenta que para realizar esta acción no debes pertenecer a ninguna familia
                  activa.
                </p>
              </section>
            </div>
